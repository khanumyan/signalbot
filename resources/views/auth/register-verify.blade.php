...
<head>
    ...
    <title>Подтверждение - Trading Helper Pro</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="auth-container">
        <div class="logo-container">
            <img src="{{ asset('images/Traiding (10).png') }}" alt="Trading Helper Pro Logo" class="logo-image" onerror="this.style.display='none';">
        </div>

        <div class="auth-card">
            <h1 class="auth-title">Подтверждение регистрации</h1>
            <p class="auth-subtitle">Откройте Telegram бота для завершения регистрации</p>
            ...
            <div class="instructions">
                ...
                <ol class="instructions-list">
                    ...
                    <li>В открывшемся боте подтвердите регистрацию</li>
    ...
    <script>
        ...
        const checkUrl = '{{ route("register.check") }}';
        ...
        function checkVerification() {
            ...
            .then(data => {
                if (data.verified) {
                    document.getElementById('statusMessage').textContent = '✅ Регистрация подтверждена! Перенаправление...';
